...
def statistic_all_score(scores, sents):
    lt_10 = []
    gt_10_to_20 = []
    gt_20 = []
    ...
    for i in range(len(sents)):
        ...
        if lo_sent <= 10:
            lt_10.append([sents[i], lo_sent, scores[i]])
        if lo_sent > 10 and lo_sent < 20:
            gt_10_to_20.append([sents[i], lo_sent, scores[i]])
        if lo_sent >= 20:
            gt_20.append([sents[i], lo_sent, scores[i]])
        # print(sent)
        # print(scores[i])
        # print()
...
if __name__ == '__main__':
    ...
    lt_10, gt_10_to_20, gt_20 = statistic_all_score(scores, sents)
    print('AMR có âm tiết <=10')
    print_statistical(lt_10)

    print('AMR có âm tiết >10 và <20')
    print_statistical(gt_10_to_20)

    print('AMR có âm tiết >=20')
    ...
    print('AMR có âm tiết <=10')
    p1, r1, f1 = get_scores_by_amr(lt_10, complete)
    print()
    print('AMR có âm tiết >10 và <20')
    p2, r2, f2 = get_scores_by_amr(gt_10_to_20, complete)
    print()
    print('AMR có âm tiết >=20')
    p3, r3, f3 = get_scores_by_amr(gt_20, complete)
    ...
    print('AMR có âm tiết <=10')
    p1, r1, f1 = get_scores_by_amr(lt_10, incomplete)
    print()
    print('AMR có âm tiết >10 và <=20')
    p2, r2, f2 = get_scores_by_amr(gt_10_to_20, incomplete)
    print()
    print('AMR có âm tiết >20')
    p3, r3, f3 = get_scores_by_amr(gt_20, incomplete)
